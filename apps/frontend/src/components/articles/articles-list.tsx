...
export function ArticlesList() {
  ...
  const { data: articles, isLoading, error, refetch } = useQuery({
    ...
    queryFn: () => {
      return apiClient.getArticles(1, 50, selectedFeed !== 'all' ? selectedFeed : undefined);
    },
  });
    ...
    <div className="bg-white rounded-lg shadow">
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center space-x-4">
          <div>
            <label className="block text-sm font-medium text-gray-700">Feed Source</label>
            <select
              value={selectedFeed}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-2 flex items-center space-x-4 text-xs text-gray-500">
                    ...
                    <span className="flex items-center space-x-1">
                      ...
                      <span>Scraped: {new Date(article.scraped_at).toLocaleDateString()}</span>
                    </span>
                  </div>
